...
def login():
    ...
    if request.method == "POST":
        ...
        return LOGIN_HTML.replace("{{error}}", "帳號或密碼錯誤"), 401
...
<title>vROps Alert Manager — 登入</title>
<style>
body{background:#0f0f1a;color:#e0e0e0;font-family:'Inter',sans-serif;
display:flex;justify-content:center;align-items:center;height:100vh;}
.login-box{background:#1a1a2e;padding:40px;border-radius:16px;
border:1px solid #2a2a4a;width:360px;box-shadow:0 8px 32px rgba(0,0,0,0.4);}
h2{color:#64ffda;margin-bottom:24px;text-align:center;}
input{width:100%;padding:12px;margin-bottom:16px;background:#0f0f1a;
border:1px solid #2a2a4a;color:#e0e0e0;border-radius:8px;font-size:1em;}
input:focus{border-color:#64ffda;outline:none;}
button{width:100%;padding:12px;background:#64ffda;color:#0f0f1a;
border:none;border-radius:8px;font-weight:600;font-size:1em;cursor:pointer;}
button:hover{background:#4dd8b5;}
.error{color:#ff6b6b;text-align:center;margin-bottom:12px;font-size:0.9em;}
</style></head><body>
<div class="login-box">
<h2>🔔 vROps Alert Manager</h2>
